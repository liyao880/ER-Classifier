...
def loadmodel(args):
    if args['dataset'] == 'mnist':
        from setup_er_mnist import Encoder, Discriminator, SmallCNN
        ...
        from setup_er_cifar10 import Encoder, Discriminator, SmallCNN        
        ...
        from setup_er_stl10 import Encoder, Discriminator, SmallCNN
